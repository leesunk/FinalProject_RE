...
public class ShNbbsController {
	...
	//	List<ShNbbsDto> list = shNbbsService.getNbbsList();
	      ...
	      ArrayList<String> wDateList = new ArrayList<String>();
	      
	      for(int i = 0; i < nbbslist.size(); i++) {
	         wDateList.add(nbbslist.get(i).getWdate());
	      }
	      for(int i = 0; i < nbbslist.size(); i++) {
	         nbbslist.get(i).setWdate(wDateList.get(i).substring(0, 10));
	      }
