...
<tr><!-- 반드시 위에서 써 놓은 거를 맞춰서 작상할것 -->
	...
	<td style="text-align: left; padding-left: 10px; 
			padding-top: 0px; padding-bottom: 0px">		<!-- 왼쪽 정렬 -->
...
<div align="center">
<table style="float: center; margin-left: 900px ">
<!-- <tr>
...
<tr>
	<td style="border: none; align-content: right">
		<button type="button" id="_btnAdd" value="글쓰기" 
			class="btn btn-default btn-block" style="width: 100px"
			onclick="location.href='nbbsupload.do'">글쓰기</button>
	</td>
</tr>
</c:if>
<!-- <tr>
		...
		<table style="margin-left: auto; margin-right: auto;
			...
			<tr>
			   <td style="padding-left: 5px">
			      <select id="_s_category" name="s_category" class="btn btn-default btn-block">
...
function goPage(pageNumber) {
	$("#_pageNumber").val(pageNumber);	// pagenumbe 보여줌
