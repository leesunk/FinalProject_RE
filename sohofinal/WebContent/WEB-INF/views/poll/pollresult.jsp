...
<tr>
	...
	<td style="text-align: left;">
		<input type="text" name="pollid" value="${poll.pollid }" size="50" readonly="readonly" style="border: 0;">
	</td>
</tr>
...
<tr>
	<th>아이디</th>
	<td style="text-align: left;">
		<input type="text" name="id" value="${login.id }" size="50" readonly="readonly" style="border: 0;">
	</td>
</tr>
...
<tr>
	<th>투표기한</th>
	<td align="left">
		<input type="text" name="id" value="${poll.wdate }" size="50" readonly="readonly" style="border: 0;">
	</td>
</tr>
...
<tr>
	...
	<td align="left">
		<strong>
			<textarea rows="1" cols="80" name="question" id="question" readonly="readonly" style="border: 0;">
