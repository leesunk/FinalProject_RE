 ...
 -->
			...
			<c:forEach var="pds" items="${pdslist }" varStatus="pdsS">
               ...
               이 글은 게시자에 의해서 삭제 되었습니다    
					...
					<td><input type="button" name="btnDown" value="다운로드" class="ebbsbutton"
	...
	<div id="buttons.wrap" align="center">
		<span class="button blue">
			<button type="button" id="_btnAdd" class="ebbsbutton">자료추가</button>
		</span>
	</div>
	<!-- 페이징 처리 -->
	<div id="paging_wrap">
...
<script type="text/javascript">
	...
	$("#btn_fileDelete").click(function() { 
		...
		var seq = document.getElementById('btn_fileDelete'); /* del부분에 아이디 값이 똑같아야함 */
