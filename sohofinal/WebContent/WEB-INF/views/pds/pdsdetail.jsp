...
<tr>
   ...
   <td style="text-align: left;">
      <input type="button" name="btnDown" value="다운로드" onclick="filedowns('${pds.filename}','${pds.seq }')" class="ebbsbutton">
   </td>
</tr>
...
<tr>
	<td colspan="2" align="center" style="padding-left: 10px">
		<button type="button" name="backBtn" id="_backBtn" value="back"
				class="ebbsbutton" onclick="location.href='pdslist.do'">목록 보기</button>
				<c:if test="${login.id eq pds.id }">
		<button type="button" id="_btnAdd" class="ebbsbutton">수정하기</button>
		<button type="button" onclick="deletechk()" class="ebbsbutton">삭제</button>
				</c:if>
	</td>
</tr>
</table>
