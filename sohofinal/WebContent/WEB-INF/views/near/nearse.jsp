...
<div style="margin-top: 12px" align="center">
	<!-- 방이름 -->
	<img alt="" src="image/ses.png" border="0" id="logo" width="300px">
...
<!-- * 카카오맵 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
<div align="center" id="daumRoughmapContainer1559108128203" class="root_daum_roughmap root_daum_roughmap_landing"></div>
...
<div align="center">
	<img alt="" src="image/v_se.png" border="0" id="backimg" style="width: 70%;padding-bottom: 100px">
</div>
<!--
	2. 설치 스크립트
