	...
	<tbody>
		...
		<tr class="_hover_tr">
			...
			<td style="text-align: left;">
				...
				<c:if test="${login.id eq null || login.id eq ShQbbs.id || login.id ne ShQbbs.id }">
		...
		<table style="margin-left: auto; margin-right: auto; margin-top: 3px; margin-bottom: 3px;">
			<tr>
				...
				<td style="padding-left: 5px">
					...
					<c:if test="${login.auth eq '3' }"> <!-- 사용자만 글쓰기 버튼 활성화  -->
					<span class="button blue">
						<button type="button" id="_btnAdd" class="btn btn-default btn-block">글쓰기</button>
					</span>
					</c:if>
				</td>
			</tr>
